...
from vrtkvm.IPy import xrange

from vrtkvm.instance import WvmInstances, WvmInstance

from libvirt import libvirtError, VIR_DOMAIN_XML_SECURE
from webkvm.settings import TIME_JS_REFRESH, QEMU_KEYMAPS, QEMU_CONSOLE_TYPES
        ...
        if request.method == 'POST':
            ...
            if 'set_console_passwd' in request.POST:
                if request.POST.get('auto_pass', ''):
                    passwd = ''.join([choice(ascii_letters + digits) for i in xrange(12)])
                else:
