...
from vrtkvm.util import get_xml_path
...
class WvmHostDetails(WvmConnect):
    def get_memory_usage(self):
        #function reutrn memory usage on node
        ...
        if type(get_freemem) == dict:
            ...
            mem_usage = {'usage': None,
                         'percent': None
                         }
        return mem_usage

    def get_cpu_usage(self):
        #function reutrn cpu usage on node
    ...
    def get_node_info(self):
        # function reutrn host server information: cpu memory disk hostname...
